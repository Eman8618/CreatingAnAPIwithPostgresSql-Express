...
const crnewpro_or=async(req:Request,res:Response)=>{
...
const sh_orprlist= async(req: Request, res: Response) => {
    try{
...
const ordersmenuinfo_routes = (app: express.Application) => {
    ...
    app.post('/ordersmenuinfo/credentialid/:credentialid/purchasedate/:purchasedate/activeorder/:activeorder/customerid/:customerid',aut_cu,cr_or)
    // Add new product to active order
    ...
    app.delete('/ordersmenuinfo/credentialid/:credentialid/id/:id',aut_cu,del_or)
