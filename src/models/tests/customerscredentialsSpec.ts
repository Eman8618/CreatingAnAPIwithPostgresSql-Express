...
describe('Customer Credentials Model',()=>{
    ...
    it('Update Customer Credential Email',async()=>{
        ...
        const cr_cucr=await cuscred.updatecustomercredentailpassword('Eman','e3@gmail.com');
        expect(cr_cucr.password_di).toEqual('e3@gmail.com')  
        })
    ...
    it('Update Customer Credential Password',async()=>{
        ...
        expect(cr_cucr.password_di).toEqual('er2344')  
        })
