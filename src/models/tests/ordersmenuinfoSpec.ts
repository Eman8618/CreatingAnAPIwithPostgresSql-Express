import { ordersmenuinfo} from "../ordersmenuinfo";
import {customerscredentials} from "../customerscredentials";
import { productsmenuinfo} from "../n_productsmenuinfo";
import { customersmenuinfo} from "../customersmenuinfo";
// To can insert dates into tables
const pd = require('postgres-date');


const cus_cred=customerscredentials();
const cusinfo=customersmenuinfo();
const prodinfo=productsmenuinfo();
const ordinfo=ordersmenuinfo();
