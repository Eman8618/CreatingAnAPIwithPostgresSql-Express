...
const ordersmenuinfo_routes = (app) => {
    ...
    app.post('/ordersmenuinfo/credentialid/:credentialid/orderquantity/:orderquantity/purchasedate/:purchasedate/activeorder/:activeorder/customerid/:customerid/productid/:productid', aut_cu_1.aut_cu, cr_or);
    ...
    app.put('/ordersmenuinfo/credentialid/:credentialid/orderid/:id/orderquantity/:orderquantity', aut_cu_1.aut_cu, up_or);
    // Delete order info with id number for order using delete request
    app.delete('/ordersmenuinfo/credentialid/:credentialid/orderid/:id', aut_cu_1.aut_cu, del_or);
