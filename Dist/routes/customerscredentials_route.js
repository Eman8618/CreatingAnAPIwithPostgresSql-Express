...
const au_cu = async (req, res, next) => {
    try {
...
*/
const customerscredentnails_routes = (app) => {
...
exports.default = customerscredentnails_routes;
//# sourceMappingURL=customerscredentials_route.js.map