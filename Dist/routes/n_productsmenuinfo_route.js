...
const n_productsmenuinfo_1 = require("../models/n_productsmenuinfo");
const pro_info = (0, n_productsmenuinfo_1.productsmenuinfo)();
// Create New Product 
const cr_prod = async (req, res) => {
...
const productsmenuinfo_routes = (app) => {
    // Create new product with post request
    app.post('/productsmenuinfo/credentialid/:credentialid/productname/:productname/price/:price/category/:category/productioncountry/:productioncountry', aut_cu_1.aut_cu, cr_prod);
    ...
    app.put('/productsmenuinfo/credentialid/:credentialid/productinfoid/:id/price/:price', aut_cu_1.aut_cu, up_pro);
    // Delete product info with id number for customer using delete request
    app.delete('/productsmenuinfo/credentialid/:credentialid/productinfoid/:id', aut_cu_1.aut_cu, del_pro);
...
exports.default = productsmenuinfo_routes;
//# sourceMappingURL=n_productsmenuinfo_route.js.map